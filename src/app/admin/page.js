        ...
        <div className="card">
          {visibleClients?.length === 0 ? (
            <div className="empty-state" style={{ padding: '48px 32px' }}>
              ...
              <div className="empty-state-title">Ingen kunder ennå</div>
              <p style={{ fontSize: '14px', color: 'var(--color-text-muted)', margin: '8px 0 16px' }}>Kom i gang ved å registrere din første kunde.</p>
              <Link href="/admin/clients/new" className="btn btn-primary">+ Legg til første kunde</Link>
            </div>
          ) : (
